                        ...
                        <div className="container">
                            <form className="appointment-form" id="appointment-form">
                                ...
                                <div className="form-group-1">
                                    <input ref="nama_perusahaan" type="text" name="nama_perusahaan" id="nama_perusahaan" placeholder="Nama Perusahaan" required />
                                    <input ref="contact_person" type="text" name="contact_person" id="contact_person" placeholder="Contact Person" required />
                                    <input ref="bagian" type="text" name="bagian" id="bagian" placeholder="Bagian" required />
                                    <input ref="alamat_perusahaan" type="text" name="alamat_perusahaan" id="alamat_perusahaan" placeholder="Alamat Perusahaan" required />
